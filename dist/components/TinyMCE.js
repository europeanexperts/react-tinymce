...
var TinyMCE = _react2.default.createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    if (!(0, _lodash.isEqual)(this.props.config, nextProps.config)) {
      this._init(nextProps.config, nextProps.content);
    }
    if (!(0, _lodash.isEqual)(this.props.id, nextProps.id)) {
      this.id = nextProps.id;
    }
    if (!(0, _lodash.isEqual)(this.props.content, nextProps.content)) {
      this._upd(nextProps.config, nextProps.content);
    }
  },
  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
    return !(0, _lodash.isEqual)(this.props.content, nextProps.content) || !(0, _lodash.isEqual)(this.props.config, nextProps.config);
  },
  ...
  _upd: function _upd(config, content) {
    if (tinymce.get(this.id).getContent() !== content) {
      var content = content || '';
